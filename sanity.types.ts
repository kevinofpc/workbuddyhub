...
export type Item = {
  ...
  description?: string;
  summary?: string;
  resourceType?: "tutorial" | "recipe" | "guide" | "video" | "course" | "article" | "case" | "official-documentation" | "community-resource";
  creator?: string;
  sourceName?: string;
  ...
  suggestedFeatures?: Array<string>;
...
export type AllSanitySchemaTypes = SanityImagePaletteSwatch | SanityImagePalette | SanityImageDimensions | SanityFileAsset | Geopoint | BlockContent | Settings | PasswordResetToken | VerificationToken | Page | BlogCategory | BlogPost | Collection | Category | Group | Tag | Item | Order | User | Account | BrandAsset | LearningPath | UseCase | CaseStudy | Guide | Recipe | SanityImageCrop | SanityImageHotspot | SanityImageAsset | SanityAssetSourceData | SanityImageMetadata | Feature | Code | Markdown | MediaTag | Slug;
